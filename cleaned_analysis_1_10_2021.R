...
ggplot(data = main_analysis_data_sum, mapping = aes(x = date,
                                                    y = total_deaths)) +
  geom_line() +
  labs(x = "Year", y = "Yearly Number of Unintentional Drug Overdose Deaths in 50 U.S. States") +
...
# pdf("Figures/num_states_with_intervention_1_9_21.pdf")
ggplot(num_states_with_intervention, aes(x = Start_Date, y = value, group = 1)) +
  # geom_point() +
  geom_line() +
  labs(x = "Year", y = "Cumulative Number of States") +
...
# pdf("Figures/num_attr_deaths_yearly_for_all_anlys_1_5_21_all_od.pdf")

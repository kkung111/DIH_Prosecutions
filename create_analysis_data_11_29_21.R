...
pop_by_age_2010_group <- pop_by_age_2010 %>% 
  ...
  filter(NAME != "United States", SEX == 0, AGE >= 18, AGE < 999) %>%
  group_by(NAME) %>%
...
# write.csv(od_data, "./Data/od_data_interpolated_unintentional_1999_2019_age_17_up_9_6_21.csv")
# write.csv(od_data, "./Data/od_data_interpolated_unintentional_1999_2019_age_18_and_up_11_29_21.csv")
...
# write.csv(full_data_set, "./Data/full_data_set_11_29_21_unintentional.csv", row.names = FALSE)
